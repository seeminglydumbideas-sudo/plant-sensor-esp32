...
_vol_inc=0;// [-2:0.1:5]
// Edge Depth
_edge_depth=3.5;// [1:0.25:10]
// Edge Border
_edge_width=0.7;// [0.1:0.1:3]
...
view_both_cases(_pos,inc(_vol,_vol_inc),_edge_depth,_edge_width,_edge_tol,_batLg, _opening);
...
// short battery
//view_print(_pos,inc(_vol,_vol_inc),_edge_depth,_edge_width,_edge_tol,_batLg, 10);// original
